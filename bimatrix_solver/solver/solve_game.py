...
def clique_enumeration(numberOfEq, index1, index2):
    ...
    fcin = open(os.path.join(BASE_DIR,'bimatrix_solver/solver/tmp/clique_input.txt'), 'w')
    ...
    os.system(os.path.join(BASE_DIR,'bimatrix_solver/solver/bin/clique')+
              " <" + os.path.join(BASE_DIR,"bimatrix_solver/solver/tmp/clique_input.txt")+
              " >" + os.path.join(BASE_DIR,"bimatrix_solver/solver/tmp/clique_output.txt"))
    # open clique enumeration output file
    fcout = open(os.path.join(BASE_DIR, 'bimatrix_solver/solver/tmp/clique_output.txt'), 'r')
...
def execute():
    ...
    args = os.path.join(BASE_DIR, 'bimatrix_solver/solver/example_input/game_to_solve.txt')
    # assert os.path.isfile(args), "%s is not a file" % args

    nrow, ncol, m1, m2 = parse_input_game(args)

    # system call to lrsnash
    result = subprocess.check_output([os.path.join(BASE_DIR,'bimatrix_solver/solver/bin/lrsnash'), args])
